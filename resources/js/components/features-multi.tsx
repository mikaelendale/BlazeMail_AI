...
export default function FeaturesMulti() {
    return (
        <section>
            <div className="py-24">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
                        <Card
                            ...
                            <div className="mask-b-from-95% -ml-2 -mt-2 mr-0.5 pl-2 pt-2">
                                <div className="relative mx-auto mt-8  overflow-hidden border h-99  rounded-t-sm border-transparent shadow ring-1 ring-foreground/5 rounded-tl-[--radius]">
                                    {/* Light mode image */}
                                    <img
                                        src="/demo/demo_send_light.png"
                                        alt="app screen"
                                        width="3000"
                                        height="1842"
                                        className="object-top-left h-full  object-cover block dark:hidden"
                                    />
                                    {/* Dark mode image */}
                                    <img
                                        src="/demo/demo_send_dark.png"
                                        alt="app screen dark"
                                        width="2880"
                                        height="1842"
                                        className="object-top-left h-full rounded-2xl object-cover hidden dark:block"
                                    />
                                </div>
                            </div>
                        </Card>
