...
import { AlertTriangle, CheckCircle, CreditCard, Download, XCircle } from 'lucide-react';
...
export default function Billing() {
    const { customer, price, subscription, billing } = usePage<SharedData>().props;
    ...
    const usage = {
        ...
        storage: { current: 45, limit: 100 }, // in GB
        ...
        <div className="container mx-auto max-w-6xl px-4 py-8">
            ...
            <Card className="mb-8">
                <CardHeader>
                    ...
                    <CardDescription>Upgrade or downgrade your plan at any time. Changes take effect immediately.</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="grid gap-6 md:grid-cols-3">
                        {plans.map((plan) => (
                            ...
                            >
                                {customer.plan === plan.id && <Badge className="absolute -top-2 left-1/2 bg-primary -translate-x-1/2">Current Plan</Badge>}
                ...
                <DialogContent>
                    ...
                    <div>
                        ...
                        {modal?.billing === 'immediate' && (
                            <div className="mt-2 text-sm text-yellow-600">You will be charged immediately with proration (Switch).</div>
                        )}
            ...
            {customer.plan !== 'free' && !subscription.states.onGracePeriod && (
                <Card className="border-destructive/20">
                    <CardHeader>
                        ...
                        <CardDescription>Once you cancel your subscription, you'll lose access to all premium features.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        This action cannot be undone. You'll lose access to all premium features at the end of your current billing
                                        period ({subscription.nextBilling}). Your data will be preserved for 30 days in case you want to reactivate.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
